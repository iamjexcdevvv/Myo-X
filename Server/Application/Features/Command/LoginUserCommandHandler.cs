...
{
    public class LoginUserCommandHandler : ICommandHandler<LoginUserCommand, AuthResult>
    {
        ...
        public async ValueTask<AuthResult> Handle(LoginUserCommand command, CancellationToken cancellationToken)
        {
